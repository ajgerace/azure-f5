...
| azure_user_pass      | VerySecurePassword |
  ...
  * These values have been copied to group_vars/all/vault.yml for you
  ...
  _Note:_ All tasks should end with _changed_ or _ok_ status. If you see any status messages that are <span style="color:red">red</span> please raise your hand.
